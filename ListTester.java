...
public class ListTester {
	...
	private void runTests() {
		...
		testTwoElementList(A_addToRearB_AB, "A_addToRear_AB", LIST_AB, STRING_AB);
		testTwoElementList(A_addAfterBA_AB, "A_addAfterBA_AB", LIST_AB, STRING_AB);
		testTwoElementList(A_addB_AB, "A_addB_B", LIST_AB, STRING_AB);
		testTwoElementList(A_add1B_AB, "A_add1B_B", LIST_AB, STRING_AB);
		...
		testThreeElementList(AB_addAfterC_ABC, "AB_addAfterC_ABC",LIST_ABC,STRING_ABC);
		...
		testTwoElementList(AB_set1B_C, "AB_set1B_C", LIST_AC, STRING_AC);
		...
		testThreeElementList(ABC_setC_B, "ABC_setC_B", List_ABD, STRING_ABD);
...
//			break;
	 ...
	 * @return [] after removeFirst(0,B)
	 */
	private IndexedUnsortedList<Integer> AB_set1B_C() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
		list.add(ELEMENT_B);
	...
	private Scenario<Integer> AB_set1B_C = () -> AB_set1B_C();
	
	/**
	 * Scenario: [A,B] -> removeLast() -> [A]
	 * @return [] after removeLast(0,B)
	 */
	 ...
	 * @return [A,B] -> addAfter(C,B)
	 */
	private IndexedUnsortedList<Integer> AB_addAfterC_ABC() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
		list.addAfter(ELEMENT_C,ELEMENT_B);
		return list;
	}
	
	private Scenario<Integer> AB_addAfterC_ABC = () -> AB_addAfterC_ABC();
	
	/**
	 * Scenario: [A,B] -> addToRear(C) -> [A,B,C]
	 * @return [A,B] -> addToRear(C)
	 */
	...
	private IndexedUnsortedList<Integer> ABC_removeB_AC() {
		IndexedUnsortedList<Integer> list = AB_addAfterC_ABC();
		list.remove(ELEMENT_B);
		return list;
	}
	...
	/**
	 * Scenario: [A,B,C] -> AddToFront(C) -> [C,A,B]
	 * @return [A,B] after atToFront(C)
	 */
	 ...
	 */
	private IndexedUnsortedList<Integer> ABC_setC_B() {
		IndexedUnsortedList<Integer> list = AB_addAfterC_ABC();
		list.set(2,ELEMENT_D);
		return list;
	}
	
	private Scenario<Integer> ABC_setC_B = () -> ABC_setC_B();
	...
	private void testTwoElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			printTest(scenarioName + "_testRemove" + contentsString.charAt(0), testRemoveElement(scenario.build(), contents[0], Result.MatchingValue));
			printTest(scenarioName + "_testRemove" + contentsString.charAt(1), testRemoveElement(scenario.build(), contents[0], Result.MatchingValue));
			printTest(scenarioName + "_testRemoveX", testRemoveElement(scenario.build(), ELEMENT_X, Result.NoSuchElement));
			printTest(scenarioName + "_testRemoveNeg1", testRemoveIndex(scenario.build(), -1, null, Result.IndexOutOfBounds));
			printTest(scenarioName + "_testRemove0", testRemoveIndex(scenario.build(), 0, contents[0], Result.MatchingValue));
			...
			printTest(scenarioName + "_testToString", testToString(scenario.build(), Result.ValidString));
			//Iterators
			//State 1 a newly initialized iterator
			printTest(scenarioName + "_testIter", testIter(scenario.build(), Result.NoException));
			printTest(scenarioName + "_testIterHasNext", testIterHasNext(scenario.build().iterator(), Result.True));
			printTest(scenarioName + "_testIterNext", testIterNext(scenario.build().iterator(), contents[0], Result.MatchingValue));
			printTest(scenarioName + "_testIterRemove", testIterRemove(scenario.build().iterator(), Result.IllegalState));
			//State 2 an iterator after one call to next
			...
			printTest(scenarioName + "_iterNext_testIterRemove", testIterRemove(iterAfterNext(scenario.build(), 1), Result.NoException));
			//State 3 an iterator after on call to next and the remove
			...
			printTest(scenarioName + "_iterNextRemove_testIterRemove", testIterRemove(iterAfterRemove(iterAfterNext(scenario.build(), 1)), Result.IllegalState));
			//State 4 two consecutive calls to next
			...
			//State 5 Two Calls to next then a call to remove
			...
			//State 6 call to next, call to remove , call to next
			printTest(scenarioName + "_iterNextRemoveNext_testIterHasNext", testIterHasNext(iterAfterNextRemoveNext(scenario.build().iterator()), Result.False));
			printTest(scenarioName + "_iterNextRemoveNext_testIterNext", testIterNext(iterAfterNextRemoveNext(scenario.build().iterator()), null,Result.NoSuchElement));
			printTest(scenarioName + "_iterNextRemoveNext_testIterRemove", testIterRemove(iterAfterNextRemoveNext(scenario.build().iterator()), Result.NoException));
			...
			if (SUPPORTS_LIST_ITERATOR) {
			      ...
			      printTest(scenarioName + "_testListIterNextHasNext", testIterHasNext(listIterAfterNext(scenario.build().listIterator(), 1), Result.True));
			      printTest(scenarioName + "_testListIterNextRemove", testIterRemove(listIterAfterNext(scenario.build().listIterator(), 1), Result.NoException));
			      printTest(scenarioName + "_testListIterNextAdd", testListIterAdd(listIterAfterNext(scenario.build().listIterator(), 1), ELEMENT_X, Result.NoException));			
			      printTest(scenarioName + "_testListIterNextSet", testListIterSet(listIterAfterNext(scenario.build().listIterator(), 1), ELEMENT_X, Result.NoException));
			      printTest(scenarioName + "_testListIterNextRemoveRemove", testIterRemove(listIterAfterRemove(listIterAfterNext(scenario.build().listIterator(), 1)), Result.IllegalState));
			      ...
			      printTest(scenarioName + "_testListIterNextNextHasNext", testIterHasNext(listIterAfterNext(scenario.build().listIterator(), 2), Result.False));
			      ...
			      printTest(scenarioName + "_testListIterNextNextPreviousRemove", testIterRemove(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 2), 1), Result.NoException));
			      printTest(scenarioName + "_testListIterNextNextPreviousAdd", testListIterAdd(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 2), 1), ELEMENT_X, Result.NoException));			
			      printTest(scenarioName + "_testListIterNextNextPreviousSet", testListIterSet(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 2), 1), ELEMENT_X, Result.NoException));
			      printTest(scenarioName + "_testListIterNextNextNextIndex", testListIterNextIndex(listIterAfterNext(scenario.build().listIterator(), 2), 2,Result.MatchingValue));
			      //a ListIterator after one call to next and the remove
			      printTest(scenarioName + "_testListIterNextRemoveRemove", testIterRemove(listIterAfterRemove(listIterAfterNext(scenario.build().listIterator(), 1)), Result.IllegalState));
			      printTest(scenarioName + "_testListIterNextRemoveAdd", testListIterAdd(listIterAfterRemove(listIterAfterNext(scenario.build().listIterator(), 1)), ELEMENT_X, Result.NoException));
			      printTest(scenarioName + "_testListIterNextRemoveSet", testListIterSet(listIterAfterRemove(listIterAfterNext(scenario.build().listIterator(), 1)), ELEMENT_X, Result.IllegalState));
			      printTest(scenarioName + "_testListIteNextRemoveHasPrevious", testListIterHasPrevious(listIterAfterRemove(listIterAfterNext(scenario.build().listIterator(), 1)), Result.False));
			      printTest(scenarioName + "_testListIteNextRemoveHasNext", testIterHasNext(listIterAfterRemove(listIterAfterNext(scenario.build().listIterator(), 1)), Result.True));
			      printTest(scenarioName + "_testListIteNextRemoveNextIndex", testListIterNextIndex(listIterAfterRemove(listIterAfterNext(scenario.build().listIterator(), 1)), 0, Result.MatchingValue));
			      printTest(scenarioName + "_testListIteNextRemovePreviousIndex", testListIterPreviousIndex(listIterAfterRemove(listIterAfterNext(scenario.build().listIterator(), 1)),-1, Result.MatchingValue));
			      //I added a one here as I am expecting to get the second value in the list before it is changed. This could be a problem??
			      printTest(scenarioName + "_testListIteNextRemoveNext", testIterNext(listIterAfterRemove(listIterAfterNext(scenario.build().listIterator(), 1)), contents[1], Result.MatchingValue));
			      printTest(scenarioName + "_testListIteNextRemovePrevious", testListIterPrevious(listIterAfterRemove(listIterAfterNext(scenario.build().listIterator(), 1)), ELEMENT_X, Result.NoSuchElement));
			      //an iterator after two calls to next then remove
			      printTest(scenarioName + "_testListIterNextNextRemoveRemove", testIterRemove(listIterAfterRemove(listIterAfterNext(scenario.build().listIterator(), 2)), Result.IllegalState));
			      printTest(scenarioName + "_testListIterNextNextRemoveAdd", testListIterAdd(listIterAfterRemove(listIterAfterNext(scenario.build().listIterator(), 2)), ELEMENT_X, Result.NoException));
			      printTest(scenarioName + "_testListIterNextNextRemoveSet", testListIterSet(listIterAfterRemove(listIterAfterNext(scenario.build().listIterator(), 2)), ELEMENT_X, Result.IllegalState));
			      printTest(scenarioName + "_testListIteNextNextRemoveHasPrevious", testListIterHasPrevious(listIterAfterRemove(listIterAfterNext(scenario.build().listIterator(), 2)), Result.True));
			      printTest(scenarioName + "_testListIteNextNextRemoveHasNext", testIterHasNext(listIterAfterRemove(listIterAfterNext(scenario.build().listIterator(), 2)), Result.False));
			      printTest(scenarioName + "_testListIteNextNextRemoveNextIndex", testListIterNextIndex(listIterAfterRemove(listIterAfterNext(scenario.build().listIterator(), 2)), 1, Result.MatchingValue));
			      printTest(scenarioName + "_testListIteNextNextRemovePreviousIndex", testListIterPreviousIndex(listIterAfterRemove(listIterAfterNext(scenario.build().listIterator(), 2)), 0, Result.MatchingValue));
			      printTest(scenarioName + "_testListIteNextNextRemoveNext", testIterNext(listIterAfterRemove(listIterAfterNext(scenario.build().listIterator(), 2)), ELEMENT_X, Result.NoSuchElement));
			      printTest(scenarioName + "_testListIteNextNextRemovePrevious", testListIterPrevious(listIterAfterRemove(listIterAfterNext(scenario.build().listIterator(), 2)), contents[0], Result.MatchingValue));
			      // an Iterator with a call to next remove then next
			      printTest(scenarioName + "_testListIterNextRemoveNextRemove", testIterRemove(listIterAfterNextRemoveNext(scenario.build().listIterator()), Result.NoException));
			      printTest(scenarioName + "_testListIterNextRemoveNextAdd", testListIterAdd(listIterAfterNextRemoveNext(scenario.build().listIterator()), ELEMENT_X, Result.NoException));
			      printTest(scenarioName + "_testListIterNextRemoveNextSet", testListIterSet(listIterAfterNextRemoveNext(scenario.build().listIterator()), ELEMENT_X, Result.NoException));
			      printTest(scenarioName + "_testListIteNextRemoveNextHasPrevious", testListIterHasPrevious(listIterAfterNextRemoveNext(scenario.build().listIterator()), Result.True));
			      printTest(scenarioName + "_testListIteNextRemoveNextHasNext", testIterHasNext(listIterAfterNextRemoveNext(scenario.build().listIterator()), Result.False));
			      printTest(scenarioName + "_testListIteNextRemoveNextNextIndex", testListIterNextIndex(listIterAfterNextRemoveNext(scenario.build().listIterator()), 1, Result.MatchingValue));
			      printTest(scenarioName + "_testListIteNextRemoveNextPreviousIndex", testListIterPreviousIndex(listIterAfterNextRemoveNext(scenario.build().listIterator()), 0, Result.MatchingValue));
			      
			      //List Iterators starting at position 0
			      printTest(scenarioName + "_testListIter0HasNext", testIterHasNext(scenario.build().listIterator(0), Result.True));
			      printTest(scenarioName + "_testListIter0Next", testIterNext(scenario.build().listIterator(0), contents[0], Result.MatchingValue));
			      printTest(scenarioName + "_testListIter0NextIndex", testListIterNextIndex(scenario.build().listIterator(0), 0, Result.MatchingValue));
			      printTest(scenarioName + "_testListIter0HasPrevious", testListIterHasPrevious(scenario.build().listIterator(0), Result.False));
			      ...
			      printTest(scenarioName + "_testListIter0NextPreviousAdd", testListIterAdd(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(0), 1), 1), ELEMENT_X, Result.NoException));			
			      printTest(scenarioName + "_testListIter0NextPreviousSet", testListIterSet(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(0), 1), 1), ELEMENT_X, Result.NoException));
			      //ListIterator starting at position 1
	...
	private void testThreeElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			//tests for scenarios resulting in a 3-element list
				...
				printTest(scenarioName + "_iterNext_testIterNext", testIterNext(iterAfterNext(scenario.build(), 1), contents[1], Result.MatchingValue));
				printTest(scenarioName + "_iterNext_testIterRemove", testIterRemove(iterAfterNext(scenario.build(), 1), Result.NoException));
				//State 3 after one call to next immediately followed by a call to remove
				printTest(scenarioName + "_iterNextRemove_testIterHasNext", testIterHasNext(iterAfterRemove(iterAfterNext(scenario.build(), 1)), Result.True));
				printTest(scenarioName + "_iterNextRemove_testIterNext", testIterNext(iterAfterRemove(iterAfterNext(scenario.build(), 1)), contents[1],Result.MatchingValue));
				printTest(scenarioName + "_iterNextRemove_testIterRemove", testIterRemove(iterAfterRemove(iterAfterNext(scenario.build(), 1)), Result.IllegalState));
				//State 4 an iterator after a call to next, a call to remove and then a call to next 
				printTest(scenarioName + "_iterNextRemoveNext_testIterHasNext", testIterHasNext(iterAfterNextRemoveNext(scenario.build().iterator()), Result.True));
				printTest(scenarioName + "_iterNextRemoveNext_testIterNext", testIterNext(iterAfterNextRemoveNext(scenario.build().iterator()), contents[2],Result.MatchingValue));
				printTest(scenarioName + "_iterNextRemoveNext_testIterRemove", testIterRemove(iterAfterNextRemoveNext(scenario.build().iterator()), Result.NoException));
				//State 5 an iterator after two consecutive calls to next
				...
				printTest(scenarioName + "_iterNextNext_testIterRemove", testIterRemove(iterAfterNext(scenario.build(), 2), Result.NoException));
				//State 6 Two Calls to next then a call to remove
				...
				printTest(scenarioName + "_iterNextNextRemove_testIterRemove", testIterRemove(iterAfterRemove(iterAfterNext(scenario.build(), 2)), Result.IllegalState));
				//State 7 Two calls to next, a call to remove, and another call to next
				printTest(scenarioName + "_iterNextNextRemoveNext_testIterHasNext", testIterHasNext(iterAfterNextNextRemoveNext(scenario.build().iterator()), Result.False));
				printTest(scenarioName + "_iterNextNextRemoveNext_testIterNext", testIterNext(iterAfterNextNextRemoveNext(scenario.build().iterator()), null,Result.NoSuchElement));
				printTest(scenarioName + "_iterNextNextRemoveNext_testIterRemove", testIterRemove(iterAfterNextNextRemoveNext(scenario.build().iterator()), Result.NoException));
				//State 8 an iterator after three consecutive calls to next
				...
				//State 9 After three Consecutive calls to next then followed by remove
				...
				if (SUPPORTS_LIST_ITERATOR) {
				      ...
				      //After 2 calls to next
				      printTest(scenarioName + "_testListIterNextNextRemove", testIterRemove(listIterAfterNext(scenario.build().listIterator(), 2), Result.NoException));
				      printTest(scenarioName + "_testListIterNextNextHasNext", testIterHasNext(listIterAfterNext(scenario.build().listIterator(), 2), Result.True));
				      printTest(scenarioName + "_testListIterNextNextAdd", testListIterAdd(listIterAfterNext(scenario.build().listIterator(), 2), ELEMENT_X, Result.NoException));
				      printTest(scenarioName + "_testListIterNextSet", testListIterSet(listIterAfterNext(scenario.build().listIterator(), 2), ELEMENT_X, Result.NoException));
				      printTest(scenarioName + "_testListIterNextNextPreviousRemove", testIterRemove(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 2), 1), Result.NoException));
				      printTest(scenarioName + "_testListIterNextNextPreviousAdd", testListIterAdd(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 2), 1), ELEMENT_X, Result.NoException));			
				      ...
				      printTest(scenarioName + "_testListIterNextNextRemoveSet", testListIterSet(listIterAfterRemove(listIterAfterNext(scenario.build().listIterator(), 2)), ELEMENT_X, Result.IllegalState));
				      printTest(scenarioName + "_testListIteNextNextRemoveHasPrevious", testListIterHasPrevious(listIterAfterRemove(listIterAfterNext(scenario.build().listIterator(), 2)), Result.True));
				      printTest(scenarioName + "_testListIteNextNextRemoveHasNext", testIterHasNext(listIterAfterRemove(listIterAfterNext(scenario.build().listIterator(), 2)), Result.True));
				      printTest(scenarioName + "_testListIteNextNextRemoveNextIndex", testListIterNextIndex(listIterAfterRemove(listIterAfterNext(scenario.build().listIterator(), 2)), 1, Result.MatchingValue));
				      printTest(scenarioName + "_testListIteNextNextRemovePreviousIndex", testListIterPreviousIndex(listIterAfterRemove(listIterAfterNext(scenario.build().listIterator(), 2)), 0, Result.MatchingValue));
				      printTest(scenarioName + "_testListIteNextNextRemoveNext", testIterNext(listIterAfterRemove(listIterAfterNext(scenario.build().listIterator(), 2)), contents[2], Result.MatchingValue));
				      printTest(scenarioName + "_testListIteNextNextRemovePrevious", testListIterPrevious(listIterAfterRemove(listIterAfterNext(scenario.build().listIterator(), 2)), contents[0], Result.MatchingValue));
				      // an Iterator with a call to next remove then next
				      printTest(scenarioName + "_testListIterNextRemoveNextRemove", testIterRemove(listIterAfterNextRemoveNext(scenario.build().listIterator()), Result.NoException));
				      printTest(scenarioName + "_testListIterNextRemoveNextAdd", testListIterAdd(listIterAfterNextRemoveNext(scenario.build().listIterator()), ELEMENT_X, Result.NoException));
				      printTest(scenarioName + "_testListIterNextRemoveNextSet", testListIterSet(listIterAfterNextRemoveNext(scenario.build().listIterator()), ELEMENT_X, Result.NoException));
				      printTest(scenarioName + "_testListIteNextRemoveNextHasPrevious", testListIterHasPrevious(listIterAfterNextRemoveNext(scenario.build().listIterator()), Result.True));
				      printTest(scenarioName + "_testListIteNextRemoveNextHasNext", testIterHasNext(listIterAfterNextRemoveNext(scenario.build().listIterator()), Result.True));
				      printTest(scenarioName + "_testListIteNextRemoveNextNextIndex", testListIterNextIndex(listIterAfterNextRemoveNext(scenario.build().listIterator()), 1, Result.MatchingValue));
				      printTest(scenarioName + "_testListIteNextRemoveNextPreviousIndex", testListIterPreviousIndex(listIterAfterNextRemoveNext(scenario.build().listIterator()), 0, Result.MatchingValue));
				      
				      //3 calls to next
				      printTest(scenarioName + "_testListIterNextNextNextRemove", testIterRemove(listIterAfterNext(scenario.build().listIterator(), 3), Result.NoException));
				      printTest(scenarioName + "_testListIterNextNextNextHasNext", testIterHasNext(listIterAfterNext(scenario.build().listIterator(), 3), Result.False));
				      printTest(scenarioName + "_testListIterNextNextNextAdd", testListIterAdd(listIterAfterNext(scenario.build().listIterator(), 3), ELEMENT_X, Result.NoException));
				      printTest(scenarioName + "_testListIterNextNextNextSet", testListIterSet(listIterAfterNext(scenario.build().listIterator(), 3), ELEMENT_X, Result.NoException));
				      printTest(scenarioName + "_testListIterNextNextNextPreviousRemove", testIterRemove(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 3), 1), Result.NoException));
				      printTest(scenarioName + "_testListIterNextNextNextPreviousAdd", testListIterAdd(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 3), 1), ELEMENT_X, Result.NoException));			
				      printTest(scenarioName + "_testListIterNextNextNextPreviousSet", testListIterSet(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 3), 1), ELEMENT_X, Result.NoException));
				      printTest(scenarioName + "_testListIterNextNextNextNextIndex", testListIterNextIndex(listIterAfterNext(scenario.build().listIterator(), 3), 3,Result.MatchingValue));
	...
	///////////////////////////////////////
	// Iterator helper methods that I added
	///////////////////////////////////////
	/**
	 * Helper method for testing iterators. Returns an Iterator that has called next() remove() and then next()
	 * @param iterator
	 * @return Iterator for the given list, after next remove next
	 */
	private Iterator<Integer> iterAfterNextRemoveNext(Iterator<Integer> iterator)
	{
		iterator.next();
		iterator.remove();
		iterator.next();
	...
	/**
	 * Helper method for testing iterators. Returns an Iterator that has called next() next() remove() and then next()
	 * @param iterator
	 * @return Iterator for the given list, after next next remove next
	 */
	private Iterator<Integer> iterAfterNextNextRemoveNext(Iterator<Integer> iterator)
	{
		iterator.next();
		iterator.next();
		iterator.remove();
	...
	private ListIterator<Integer> listIterAfterNextRemoveNext(ListIterator<Integer> iterator)
	{
		iterator.next();
		iterator.remove();
		iterator.next();
